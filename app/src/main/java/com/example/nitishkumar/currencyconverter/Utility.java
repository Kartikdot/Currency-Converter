...
class Utility {
    ...
    static List<Country> getCountries(String requestUrl) {
        ...
        List<Country> countries = fetchCountriesFromPref(exchangeRates);
        return countries;
    }

    private static List<Country> fetchCountriesFromPref(SharedPreferences exchangeRates) {
...
//            Log.e(LOG_TAG,entry.getKey()+":"+Double.parseDouble(entry.getValue())+"");
    ...
    private static void setFlags(List<Country> flags) {
